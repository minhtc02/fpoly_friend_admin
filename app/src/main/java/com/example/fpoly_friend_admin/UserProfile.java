...
public class UserProfile implements Serializable {
    ...
    public UserProfile(int availability, String userId, String name, int age, String gender, String education, String imageUri,String token) {
    ...
    public UserProfile(int availability, String userId, String name, int age, String gender, String education, String imageUri,int match) {
        this.availability = availability;
        this.userId = userId;
        this.name = name;
        this.age = age;
